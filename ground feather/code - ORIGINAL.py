...
while send_that_shit != "Y":
    
    send_that_shit = input("Send the package? Enter [Y/N]: ").upper()
    # allows packet to be sent upon a case-insensitive user input

    if send_that_shit == "Y":
        rfm9x.send(cut_away_message)
        print(cut_away_message)
        time.sleep(1)
